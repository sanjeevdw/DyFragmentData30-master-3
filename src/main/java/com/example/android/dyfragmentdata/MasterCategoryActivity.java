...
public class MasterCategoryActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {

    private DrawerLayout mDrawerLayout;
    private NavigationView navigationView;
    private Session session;
    private String sessionToken;
    private ArrayList<MasterCategory> gridMasterCategories;
    private MasterCategory masterCategory;
    private GridMasterAdapter gridMasterAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gridMasterCategories = new ArrayList<MasterCategory>();
        ...
        merchantButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentMechantLogin = new Intent(MasterCategoryActivity.this, MerchantLoginActivity.class);
        ...
        deliveryButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentDelivery = new Intent(MasterCategoryActivity.this, DeliveryActivity.class);
    ...
    private void sendGridMasterCategoryRequest() {

        RequestQueue queue = Volley.newRequestQueue(this);
        String url = "https://www.godprice.com/api/category_master.php";
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                        ...
                        try {
                            ...
                            if (data.length() > 0) {
                                ...
                                for (int i = 0; i < data.length(); i++) {
                                    ...
                                    masterCategory = new MasterCategory(categoryId, categoryName, categoryImage);
                                    gridMasterCategories.add(masterCategory);
                                    gridMasterAdapter = new GridMasterAdapter(MasterCategoryActivity.this, gridMasterCategories);
                                    // Get a reference to the GridView, and attach the adapter to the gridView.
                                    gridView = (GridView) findViewById(R.id.gridView);
                                    gridView.setAdapter(gridMasterAdapter);
                                    gridMasterAdapter.notifyDataSetChanged();
                                    gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                        ...
                                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                            ...
                                            Intent intent = new Intent(MasterCategoryActivity.this, ParentCategoryActivity.class);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(MasterCategoryActivity.this, "Error Occurred", Toast.LENGTH_SHORT).show();
